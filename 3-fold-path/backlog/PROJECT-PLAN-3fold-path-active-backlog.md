...
|----|-------------|----------|-------|
| C-00 | Sci & Buddha Keynote | P1 | Blocked on source files from user. Unblocks C-02a/b/c/d |
| MI-M-T-D02 | 4-step-noble-steps-to-MI-M-T — Step 2 | P3 | Step 1 (D-01) done in zemla v1.6.2. Step 2 scope to be confirmed next sprint |
| MI-M-T-D03 | 4-step-noble-steps-to-MI-M-T — Step 3 | P4 | Depends on MI-M-T-D02 |
| MI-M-T-D04 | 4-step-noble-steps-to-MI-M-T — Step 4 | P4 | Depends on MI-M-T-D03 |
| DELTA-01 | bodyterapie Phase 5 multilingual seeder arch | P4 | Deferred to Phase 5 |
| Z-06 | Lorenz Attractor interactive simulator (zemla) | P4 | Low priority |
| A-F1-03 | HMSW33 mim2000 carousel evaluation | P4 | Low priority |
